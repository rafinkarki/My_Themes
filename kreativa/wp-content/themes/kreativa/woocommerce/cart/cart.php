						...
						<td colspan="6" class="actions">
							<?php if ( WC()->cart->coupons_enabled() ) { ?>
								<div class="coupon form-inline">
									<label for="coupon_code"><?php //_e( 'Coupon', 'woocommerce' ); ?></label> <input type="text" name="coupon_code" class="form-control" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', 'woocommerce' ); ?>" />
									 <input type="submit" class="btn btn-primary" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
									<?php do_action( 'woocommerce_cart_coupon' ); ?>

									<?php } ?>

							<input type="submit" class="pull-right btn btn-primary update_cart" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" />
